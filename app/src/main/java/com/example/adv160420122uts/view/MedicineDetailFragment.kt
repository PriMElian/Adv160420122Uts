...
import com.example.adv160420122uts.databinding.FragmentMedicineDetailBinding
...
class MedicineDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        dataBinding = DataBindingUtil.inflate<FragmentMedicineDetailBinding>(inflater,
            R.layout.fragment_medicine_detail, container, false)
    ...
    private fun observeViewModel() {
        ...
        medicineDetailViewModel.medicineLD.observe(viewLifecycleOwner, Observer {
